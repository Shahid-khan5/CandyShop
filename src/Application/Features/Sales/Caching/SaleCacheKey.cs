...
namespace CleanArchitecture.Blazor.Application.Features.Sales.Caching;
/// <summary>
/// Static class for managing cache keys and expiration for Sale-related data.
/// </summary>
public static class SaleCacheKey
{
    ...
    public const string GetAllCacheKey = "all-Sales";
    ...
    public static string GetByIdCacheKey(string parameters) {
        return $"SaleCacheKey:GetByIdCacheKey,{parameters}";
    }
