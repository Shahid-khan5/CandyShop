...
public class DenyCampaignCommand: ICacheInvalidatorRequest<Result<int>>
{
      [Description("Id")]
    ...
    private class Mapping : Profile
    {
        public Mapping()
        {
            CreateMap<CampaignDto, DenyCampaignCommand>(MemberList.None);
            CreateMap<DenyCampaignCommand, Campaign>(MemberList.None);
         
        }
    }
}

public class DenyCampaignCommandHandler : IRequestHandler<DenyCampaignCommand, Result<int>>
{
    private readonly IApplicationDbContext _context;
    private readonly IMapper _mapper;
    private readonly IStringLocalizer<AddEditCampaignCommandHandler> _localizer;
    public DenyCampaignCommandHandler(
    ...
    public async Task<Result<int>> Handle(DenyCampaignCommand request, CancellationToken cancellationToken)
    {
        if (request.Id > 0)
        {
            ...
            item.Status = CampaignStatus.Denied;
