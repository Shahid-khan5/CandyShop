...
namespace CleanArchitecture.Blazor.Application.Features.Campaigns.Caching;
/// <summary>
/// Static class for managing cache keys and expiration for Campaign-related data.
/// </summary>
public static class CampaignCacheKey
{
    ...
    public const string GetAllCacheKey = "all-Campaigns";
    public const string GetTop3InProgressCacheKey = nameof(GetTop3InProgressCacheKey);
    public static string GetPaginationCacheKey(string parameters) {
        return $"CampaignCacheKey:CampaignsWithPaginationQuery,{parameters}";
    }
    public static string GetByNameCacheKey(string parameters) {
        return $"CampaignCacheKey:GetByNameCacheKey,{parameters}";
    }
    public static string GetByIdCacheKey(string parameters) {
        return $"CampaignCacheKey:GetByIdCacheKey,{parameters}";
    }
